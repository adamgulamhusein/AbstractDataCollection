        ...
        for i in range(self.num_classifiers):
            ...
            for train_idx, test_idx in self.cv.split(subX,suby):
                ...
                if i == 0:
                    ...
                    #self.clf0and1.fit(X_train_cov, y_train)
                    #preds = self.clf0and1.predict(X_test_cov)
                else:
                    ...
                    #self.clf0and2.fit(X_train_cov, y_train)
                    #preds = self.clf0and2.predict(X_test_cov)
