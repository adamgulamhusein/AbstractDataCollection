...
class switch_classifier(generic_classifier):
    def set_switch_classifier_settings(self, n_splits = 2, rebuild = True, random_seed = 42, activation_main = 'relu', activation_class = 'sigmoid'):
        ...
        self.clf0and1 = LinearDiscriminantAnalysis()
        self.clf0and2 = LinearDiscriminantAnalysis()
        ...
        for i in range(self.num_classifiers):
            ...
            for train_idx, test_idx in self.cv.split(subX,suby):
                ...
                if i == 0:
                    ...
                    self.clf0and1.fit(X_train_scaled, y_train)
                    preds = self.clf0and1.predict(X_test_scaled)
                else:
                    ...
                    self.clf0and2.fit(X_train_scaled, y_train)
                    preds = self.clf0and2.predict(X_test_scaled)
